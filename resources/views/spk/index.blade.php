            ...
            @else
                ...
                <div class="bg-indigo-50 border border-indigo-100 rounded-2xl p-4 mb-6">
                    ...
                    <p class="text-[10px] text-indigo-700 leading-relaxed">
                        Sistem membandingkan menu Anda berdasarkan 2 hal: <strong>Seberapa sering dipesan (Laris)</strong> dan <strong>Seberapa besar untungnya (Cuan)</strong>. Menu kemudian dikelompokkan agar Anda tahu menu mana yang harus dipertahankan atau dievaluasi.
                    </p>
                </div>
